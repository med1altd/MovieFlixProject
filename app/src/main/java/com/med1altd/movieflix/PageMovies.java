...
public class PageMovies extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_pagemovies, container, false);
    ...
    void Calculate() {
        ...
        RecyclerViewAdapterCategories recyclerViewAdapterCategories = new RecyclerViewAdapterCategories(getContext(),  Categories, "Movies");
