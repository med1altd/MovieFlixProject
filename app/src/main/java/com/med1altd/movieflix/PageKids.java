...
public class PageKids extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_pagekids, container, false);
    ...
    void Calculate() {
        ...
        RecyclerViewAdapterCategories recyclerViewAdapterCategories = new RecyclerViewAdapterCategories(getContext(), Categories, "Kids");
